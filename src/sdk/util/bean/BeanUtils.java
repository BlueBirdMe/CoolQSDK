...
public class BeanUtils {
    ...
    public static void registerClass(Class clazz) {
        ...
        for (Field f : clazz.getFields()) {
            if (!fs.containsKey(f.getName()) && !f.isAnnotationPresent(Ignore.class)) {//避免被父类的属性覆盖
                f.setAccessible(true);
                fs.put(f.getName(), f);
            }
        }
...
//        System.out.println("[init]register bean class:"+clazz.getCanonicalName());
    }
    ...
    public static <T> T build(T instance, JSONObject json) throws Exception {
        return fromJson.build(instance, JSONUtils.googleJsonParser.parse(json.toString()).getAsJsonObject());
    }
...
//                System.out.println(clazz.getName() + "中的选择器:" + selector.value()[n] + ",选择类:" + selector.clazz()[n].getName() + ",子节点:" + sub);
    ...
    private static class toJson {
        ...
        public static JsonElement toJsonElement(Object o) throws Exception {
            ...
            if (o.getClass().isPrimitive() || o instanceof Number || o instanceof Character || o instanceof Boolean || o instanceof String) {
                return toJsonPrimitive(o);//基础数据类型
            }
        ...
        private static JsonObject toJsonObject(Object o) throws Exception {
            ...
            if (fs == null) {
                throw new RuntimeException("类" + o.getClass().getName() + "未注册");
            }
...
//                    System.out.println("set " + f.getName() + "(" + f.getType().getName() + ")" + " " +o.getClass().getName()+":"+ o.toString());
                    f.set(instance, o);
                } else {
                    System.out.println(clazz.getName() + "中没有属性:" + key + ",忽略之");
                }
            }
            return instance;
        }
