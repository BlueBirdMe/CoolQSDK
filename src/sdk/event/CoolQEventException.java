...
public class CoolQEventException extends Throwable {
     ...
     */
    public CoolQEventException(Throwable throwable) {
        cause = throwable;
    }
     ...
     * @param message 信息
     */
    public CoolQEventException(Throwable cause, String message) {
        super(message);
        this.cause = cause;
    }
     ...
     * @param message 信息
     */
    public CoolQEventException(String message) {
        super(message);
        cause = null;
    }
